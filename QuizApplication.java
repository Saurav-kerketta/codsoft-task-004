...
public class QuizApplication {
    ...
    static QuizQuestion[] questions = {
        new QuizQuestion("what is the capital of Indai?", new String[] {"A. Delhi", "B. mumbai", "C. chennai", "D. Bangaluru"}, 'A'),
        new QuizQuestion("Who is current prime minister of india'?", new String[] {"A. Narendra modi", "B. Manmohan singh", "C. Atalbihari vajpayee", "Joe biden"}, 'A'),
